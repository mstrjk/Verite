package teacommontea.veritechasse.Vanilla.PlayerArmour.Leggings.Support;
...
public final class Leggings {

    public static final ArmourType TYPE = ArmourType.LEGGINGS;

    public static final int UNIT_DURABILITY = 15;

    private Leggings() {
    }

    public static int defence(Material material) {
        return material.defenceLeggings();
    }
