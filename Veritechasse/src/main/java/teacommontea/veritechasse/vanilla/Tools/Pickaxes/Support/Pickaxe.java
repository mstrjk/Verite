package teacommontea.veritechasse.vanilla.Tools.Pickaxes.Support;
...
public final class Pickaxe {
    ...
    public static final ToolKind KIND = ToolKind.PICKAXE;

    public static final float ATTACK_DAMAGE_BASELINE = 1.0F;
    public static final float ATTACK_SPEED_BASELINE = -2.8F;
