...
public final class DiamondSpear {

    public static final String KEY = "diamond_spear";
    ...
    public static final float ATTACK_DURATION = 1.05F;
    public static final float DAMAGE_MULTIPLIER = 1.075F;
    public static final float DELAY = 0.5F;

    public static final float DISMOUNT_TIME = 3.0F;
    public static final float DISMOUNT_THRESHOLD = 10.0F;
    public static final float KNOCKBACK_TIME = 6.5F;
    public static final float KNOCKBACK_THRESHOLD = 5.1F;
    public static final float DAMAGE_TIME = 10.0F;
