...
public final class WoodenSpear {

    public static final String KEY = "wooden_spear";
    ...
    public static final float ATTACK_DURATION = 0.65F;
    public static final float DAMAGE_MULTIPLIER = 0.7F;
    public static final float DELAY = 0.75F;

    public static final float DISMOUNT_TIME = 5.0F;
    public static final float DISMOUNT_THRESHOLD = 14.0F;
    public static final float KNOCKBACK_TIME = 10.0F;
    public static final float KNOCKBACK_THRESHOLD = 5.1F;
    public static final float DAMAGE_TIME = 15.0F;
