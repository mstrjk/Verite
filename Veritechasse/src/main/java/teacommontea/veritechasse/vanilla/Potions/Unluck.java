...
public final class Unluck {

    public static final String KEY = "unluck";
    ...
    public static double penalty(int amplifier) {
    ...
    public static double luckFrom(double baseLuck, int amplifier) {
        return Attributes.LUCK.sanitize(baseLuck + penalty(amplifier));
    }
